...
def get_available_templates():
    ...
    # Ensure "Not Yet Specified" option points to the default template.
    unhcr_template_file = "unhcr_template.json"
...
def load_template(template_name: str):
    """
    Loads a specific template by its filename.
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error parsing template file.")
